...
# Amount of Boy names that start with Z 
# count = 0
# for name in names:
#     if name[0][0] == "Z" and name[2] == "Boy":
#         count+=1
# print(count)

# Most common girl name that starts with Q
# current_high = 0
# for name in names:
#     if name[0][0] == "Q" and name[2] == "Girl" and name[1] > current_high:
#         current_high = name[0]
# print(current_high)
...
current = 0
for name in names:
    if name[0][0] in "AEIOU" and name[0][-1] in "aeiou":
        current += 1
print(current)
