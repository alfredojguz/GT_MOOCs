public class Gameplay {
    // not to be turned in; testing abstract classes and interfaces

    // Chegg notes 1
    // In the Gameplay class, create instances of the
    // Player, RedAstronaut, BlueAstronaut, ImpostorImpl, and 
    // CrewmateImpl classes to simulate the gameplay.
